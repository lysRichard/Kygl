...
{
    public partial class patentList : System.Web.UI.Page
    {
        ...
        {
            string sql = "";
            sql += "select a.*,b.name as teacher_name from patentinfo as a left join teacherinfo as b on a.teacher_number=b.teacher_id where 1=1";
            if (TextName.Text.Trim() != "")/*inner join, left join, right jon*/

            {
                sql += " and a.patent_number like '%" + TextName.Text.Trim() + "%'";
            }
        ...
        protected void btnDelAll_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Class.DelInfo("delete from patentinfo where id in (" + ggid + " )");
                WebJS.Alert("删除完成");
                dataBind();
        ...
        protected void infoList_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            try
            {
                data.Exesql("delete from patentinfo where id=" + id);
                dataBind();
            }
            catch (Exception ex)
            {
        ...
        protected void infoList_SelectedIndexChanged(object sender, EventArgs e)
        {
